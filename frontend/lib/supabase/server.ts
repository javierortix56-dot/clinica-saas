...
// Bloqueo de disponibilidad (p. ej. un evento importado de Google Calendar o un
// bloqueo manual). Se dibuja como franja gris "Ocupado" en la grilla, distinto
// de los turnos de pacientes.
